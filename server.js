...
app.get('/games/family-feud/players',(_,r)=>r.sendFile(path.join(__dirname,'public','games','family-feud','players.html')));app.get('/games/mafia/',(_,r)=>r.sendFile(path.join(__dirname,'public','games','mafia','players.html')));app.get('/games/mafia/players',(_,r)=>r.sendFile(path.join(__dirname,'public','games','mafia','players.html')));app.get('/games/bomb/',(_,r)=>r.sendFile(path.join(__dirname,'public','games','bomb','index.html')));app.get('/games/bomb/roles',(_,r)=>r.redirect('/games/bomb/'));app.get('/games/bomb/presenter',(_,r)=>r.redirect('/games/bomb/'));app.get('/games/bomb/display',(_,r)=>r.redirect('/games/bomb/'));app.get('/games/bomb/players',(_,r)=>r.sendFile(path.join(__dirname,'public','games','bomb','players.html')));
